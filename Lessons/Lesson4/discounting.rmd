...
##HOUSE
# Case & Small
Case_HH_sml <- dt_PaidCase %>% filter(dataset_type=="CASE" , Business == "House" , ClaimSize=="Small") 
Case_HH_sml_triangle <- Case_HH_sml %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Case_HH_sml_triangle
plot(Case_HH_sml_triangle)
plot(predict(chainladder(Case_HH_sml_triangle)))
ata(Case_HH_sml_triangle)
# Case & Large
Case_HH_lrg <- dt_PaidCase %>% filter(dataset_type=="CASE" , Business == "House" , ClaimSize=="Large") 
Case_HH_lrg_triangle <- Case_HH_lrg %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Case_HH_lrg_triangle
plot(Case_HH_lrg_triangle)
plot(predict(chainladder(Case_HH_lrg_triangle)))
ata(Case_HH_lrg_triangle)
# Paid & Large
Paid_HH_lrg <- dt_PaidCase %>% filter(dataset_type=="PAID" , Business == "House" , ClaimSize=="Large") 
...
## Case majú rýchlu klesajúcu tendenciu, Large vyraznejšiu ako Small
## Paid sú pomerne vyrovnané


##3rd PARTY
# Case & Small
Case_P_sml <- dt_PaidCase %>% filter(dataset_type=="CASE" , Business == "3rd Party" , ClaimSize=="Small") 
Case_P_sml_triangle <- Case_P_sml %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Case_P_sml_triangle
plot(Case_P_sml_triangle)
plot(predict(chainladder(Case_P_sml_triangle)))
ata(Case_P_sml_triangle)
# Case & Large
Case_P_lrg <- dt_PaidCase %>% filter(dataset_type=="CASE" , Business == "3rd Party" , ClaimSize=="Large") 
Case_P_lrg_triangle <- Case_P_lrg %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Case_P_lrg_triangle
plot(Case_P_lrg_triangle)
plot(predict(chainladder(Case_P_lrg_triangle)))
ata(Case_P_lrg_triangle)
# Paid & Small
Paid_P_sml <- dt_PaidCase %>% filter(dataset_type=="PAID" , Business == "3rd Party" , ClaimSize=="Small") 
Paid_P_sml_triangle <- Paid_P_sml %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Paid_P_sml_triangle
plot(Paid_P_sml_triangle)
plot(predict(chainladder(Paid_P_sml_triangle)))
ata(Paid_P_sml_triangle)
# Paid & Large
Paid_P_lrg <- dt_PaidCase %>% filter(dataset_type=="PAID" , Business == "3rd Party" , ClaimSize=="Large") 
Paid_P_lrg_triangle <- Paid_P_lrg %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
Paid_P_lrg_triangle
plot(Paid_P_lrg_triangle)
plot(predict(chainladder(Paid_P_lrg_triangle)))
ata(Paid_P_lrg_triangle)

## Case Small klesajú, Case Large skáču v niektorých rokoch viac ako v iných, ale vo všeobecnosti nevidím trend
## Paid rastú Small výraznejšie ako Large
...
##HOUSE
#Large
CaseAndPaid_HH_lrg <- dt_PaidCase %>% filter( Business == "House" , ClaimSize=="Large") 
CaseAndPaid_HH_lrg_triangle <- CaseAndPaid_HH_lrg %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_HH_lrg_triangle
plot(CaseAndPaid_HH_lrg_triangle)
plot(predict(chainladder(CaseAndPaid_HH_lrg_triangle)))
ata(CaseAndPaid_HH_lrg_triangle)
#Small
CaseAndPaid_HH_sml <- dt_PaidCase %>% filter( Business == "House" , ClaimSize=="Small") 
CaseAndPaid_HH_sml_triangle <- CaseAndPaid_HH_sml %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_HH_sml_triangle
plot(CaseAndPaid_HH_sml_triangle)
plot(predict(chainladder(CaseAndPaid_HH_sml_triangle)))
ata(CaseAndPaid_HH_sml_triangle)

##Large su vyrovnanejšie, Small viac "skáču"


##3rd PARTY
#Large
CaseAndPaid_P_lrg <- dt_PaidCase %>% filter( Business == "3rd Party" , ClaimSize=="Large") 
CaseAndPaid_P_lrg_triangle <- CaseAndPaid_HH_lrg %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_P_lrg_triangle
plot(CaseAndPaid_P_lrg_triangle)
plot(predict(chainladder(CaseAndPaid_P_lrg_triangle)))
ata(CaseAndPaid_P_lrg_triangle)
#Small
CaseAndPaid_P_sml <- dt_PaidCase %>% filter( Business == "3rd Party" , ClaimSize=="Small") 
CaseAndPaid_P_sml_triangle <- CaseAndPaid_P_sml %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_P_sml_triangle
plot(CaseAndPaid_P_sml_triangle)
plot(predict(chainladder(CaseAndPaid_P_sml_triangle)))
ata(CaseAndPaid_P_sml_triangle)

#Large su dosť vyrovnaé, Small sa mi na začiatku zdaju dosť nepravidelné, nevidím nejaký trend, potom sa ale postupne objavuje podobnosť medzi jednotl. rokmi
```
...
##HOUSE
CaseAndPaid_HH_smlANDlarge <- dt_PaidCase %>% filter(Business == "House") 
CaseAndPaid_HH_smlANDlarge_triangle <- CaseAndPaid_HH_smlANDlarge %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_HH_smlANDlarge_triangle
plot(CaseAndPaid_HH_smlANDlarge_triangle)
plot(predict(chainladder(CaseAndPaid_HH_smlANDlarge_triangle)))

##3rd PARTY 
CaseAndPaid_P_smlANDlarge <- dt_PaidCase %>% filter(Business == "3rd Party") 
CaseAndPaid_P_smlANDlarge_triangle <- CaseAndPaid_P_smlANDlarge %>% as.triangle(origin="ay", dev="dy", value="SumOfamount")
CaseAndPaid_P_smlANDlarge_triangle
plot(CaseAndPaid_P_smlANDlarge_triangle)
plot(predict(chainladder(CaseAndPaid_P_smlANDlarge_triangle)))

#short tail sú vyrovnané pomerne rýchlo, narozdiel od toho ale long tail sa vyrovnávajú dlhšie a aj "náklady" sa časom môžu výraznejšie meniť ako v short tail
#House ma viac short tail ako 3rd Party, tam je to viac long tail
...
ata(CaseAndPaid_P_smlANDlarge_triangle)
ata(CaseAndPaid_HH_smlANDlarge_triangle)
ROZDIEL1 <- ata(CaseAndPaid_HH_smlANDlarge_triangle) - ata(CaseAndPaid_P_smlANDlarge_triangle)
ROZDIEL1
plot(ROZDIEL1)
ROZDIEL2 <- ata(CaseAndPaid_P_smlANDlarge_triangle) - ata(CaseAndPaid_HH_smlANDlarge_triangle)
ROZDIEL2
plot(ROZDIEL2)
